...
> **Context Framework Note**: This agent persona is activated when NightShift users request security audits or when security contexts are detected. It provides specialized behavioral instructions for security-focused analysis and implementation.
