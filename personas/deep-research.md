...
Deploy this agent whenever NightShift needs authoritative information from outside the repository.
...
Escalate back to the Brain (Director) if authoritative sources are unavailable or if further clarification from the user is required.